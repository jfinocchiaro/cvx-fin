...
\citet{ramaswamy2016convex} introduce \emph{convex calibration dimension} for problems in Quadrant 1 to study the prediction dimension of convex calibrated losses; in Q1, this is precisely equal to convex consistency dimension of a target loss.
