...
\raft{I think okay for now -- $d$-flats is mentioned in the abstract}
\end{abstract}
...
\jessiet{cites?}
\raft{Yeah... let's figure this out after submission, since they are at least in \S~\ref{sec:risk-measures}.}
