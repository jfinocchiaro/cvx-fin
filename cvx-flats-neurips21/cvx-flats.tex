...
Using this tool, we give the first prediction dimension bounds for risk measures with respect to convex surrogates, addressing the open question for type (II) above. \jessiet{above = \citet{frongillo2015elicitation}?}
...
\jessiet{Cut this sentence?  Or rephrase to be technically correct.  We bring up the mean with set notation right after the equation.}
