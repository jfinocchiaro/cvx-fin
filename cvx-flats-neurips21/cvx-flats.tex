...
\maketitle
\jessiet{Rethink the title? Try: Unifying lower bounds on convex consistency dimension via $d$-flats.  Not a huge fan because $d$-flats doesn't signal too much until after someone has read the paper/abstract.}
\raft{I think okay for now -- $d$-flats is mentioned in the abstract}
\jessiet{What is okay for now?  The abstract doesn't mention prediction dimension}
\begin{abstract}
