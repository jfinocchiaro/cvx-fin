...
\draw[orange, very thick,dashed] (0.3,0.7,0) -- (0.3,0.7,2);
%\draw[orange, very thick] (0.7,0.3,0) -- (0.7,0.3,2);
\end{scope}
\node[inner sep=2pt] (levset1) at (0.3,0.7,-.3) {$\Gamma_{0.4}\!\!$};
...
\draw[myorange, dashed] (A) -- (0,1/3,2/3);
\end{scope}
\def\c{0.8}
\pgfmathsetmacro\aa{0.5*(sqrt(1-\c)+1)}
\pgfmathsetmacro\bb{0.5*\c}
\node (levset) at (0.5,0.5,-.3) {$\Gamma_{0.8}$};
...
\begin{scope}
\clip (h) -- (m) -- (l) -- (h);
\draw[myblue,thin] (1/4,0,3/4) -- (0,1/4, 3/4);
\draw[myblue,thin] (1/8,1/8,3/4) -- (1/2, 1/2,0);
\def\e{1/16};
\draw[orange, dashed] (1/8 + \e, 0, 1 - 1/8 - \e) -- (0, 1 - 1/8 - \e, 1/8 + \e);
\draw[orange, dashed] (1/2 + \e, 1/2- \e, 0) -- (\e, 0,1- \e);
\node (point) at (1/8 + \e, 1/8 -\e/2, 3/4 - \e/2) {$\bullet$};
%\draw[orange, very thick] (0.3,0.7,0) -- (0.3,0.7,2);
%\draw[orange, very thick] (0.7,0.3,0) -- (0.7,0.3,2);
\end{scope}
\node[inner sep=2pt] (levsetmin1) at (1/2, 1/4,1/4) {$\Gamma_{-1}$};
\node[inner sep=2pt] (levset1) at (1/4,1/2,1/4) {$\Gamma_{1}\!\!$};
%\draw[-latex,thin] (levset2) edge[in=270,out=90] (0.7,0.3,0);
%\draw[-latex,thin] (levset1) edge[in=270,out=90] (0.3,0.7,0);
\placefiglabel{(Q2)}
\end{tikzpicture}
