...
Therefore, property elicitation---which studies the exact minimizers of loss functions---allows us to give general lower bounds that apply across all four quadrants.
...
A careful examination of the arguments of~\citet{frongillo2020elicitation} and~\citet{dearborn2020indirect} reveals that they largely rely on the containment of $d$-flats in level sets, rather than the full structure of identifiable properties.
...
Risk measures include the upper confidence bound $\E[Y] + \lambda \sqrt{\Var[Y]}$, or the Conditional Value at Risk (CVaR) defined below, in either conditional or unconditional contexts.
