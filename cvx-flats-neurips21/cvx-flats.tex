...
\begin{abstract}
  ...
  We present a new tool based on property elicitation to study the prediction dimension of convex surrogate loss functions.
...
Challenges of type (II) include risk measures such as conditional value at risk (CVaR), with applications in financial regulation, robust engineering design, and algorithmic fairness.
...
We can show $\eliccvx(\Var)=2$, meaning the lowest dimension of a convex loss to estimate conditional variance is 2. %~\citep{osband1985providing,lambert2018elicitation}.
