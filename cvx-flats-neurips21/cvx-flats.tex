...
(See \S~\ref{app:minnable-assumption} for a discussion of this assumption.)\jessiet{Change order so it's App A?}\raft{No need, but I think we should consolodate this discussion and the variance example into one ``omitted discussion and examples'' section}
