...
We can apply Lemma~\ref{lem:convex-flats-inf-dim} to construct lower bounds on convex consistency dimension for targets across all four quadrants.
This is demonstrated in Figure~\ref{tab:illustrate-quadrant-apps}.
