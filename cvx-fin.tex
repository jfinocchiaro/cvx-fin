...
\begin{abstract}
  \bo{TODO - iterate!}
  We formalize and study two approaches to designing convex surrogate loss functions for problems such as classification or ranking.
  ...
  We prove an equivalence: if embedding is possible, than it can be done with a polyhedral loss, and 
