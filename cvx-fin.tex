...
We define the elicitation complexities of various classes of loss functions as follows: elic$_\C(\gamma)$ is the minimum dimension $d$ such that $\gamma$ can be indirectly elicited by a loss function $L: \reals^d \to \reals^\Y$ in the class $\C$.
