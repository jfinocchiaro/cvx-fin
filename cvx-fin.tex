...
\begin{proof}
  ...
  First, note that when $\alpha \geq \frac{n-1}{n}$, the abstain property decomposes into the mode, as the abstain cell is empty.
  Given $\frac{n-1}{n} > \alpha > 1/2$, we can write the matrix $B$ describing the abstain cell as follows:
	\[ B = \begin{pmatrix}
       -\beta &  1 &  1 & \cdots & 1  \\
       1  & -\beta &  1 & \cdots & 1  \\
          &    &    & \vdots &    \\
  ...
  We know that $\beta \in (0,1)$ as the inequalities are strict.
\end{proof}
