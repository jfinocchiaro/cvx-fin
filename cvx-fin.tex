...
%  \cite{bartlett2008classification} studies the abstain property with $n=2$ and shows a variation of the hinge loss that is one convex surrogate that elicits the abstain property to two outcomes.
  ...
  One of the first works, to our knowledge, that generalizes the construction of convex surrogates beyond the binary outcome setting comes from~\cite{ramaswamy2018consistent}-- originally appearing in 2014.
