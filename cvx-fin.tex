...
\paragraph{Summary.}
This work forms part of a broader research program to understand the behaviors of loss functions, surrogate losses, link functionss connecting the two, and the properties of distributions that are elicited by these losses.
