...
\begin{proof}
  ...
  We simply define $f:\reals^d$ to be any single-valued function such that $f(\varphi(r)) = r$ for all $r\in\R$, $f(v) \in F(v)$ whenever $v\in\V$, and $f(v) \in \R$ arbitrary when $v\notin\V$.
