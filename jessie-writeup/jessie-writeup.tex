...
\begin{definition}\label{def:unlabeled-nonredundant}
  ...
  \raft{Have not defined elicitability for unlabeled properties.  Also, what does ``almost everywhere'' mean in this context, since $\That$ is just a set of sets?  I think we just want to say that there are no distinct $\theta_1,\theta_2 \in \Theta$ such that $\theta_1 \subseteq \theta_2$.}
