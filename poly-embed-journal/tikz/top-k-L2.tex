...
\draw[fill = blue, fill opacity = 0.2] (h) -- (one) -- (uniform) -- (two) -- cycle;
\draw[fill = blue, fill opacity = 0.2] (l) -- (five) -- (uniform)  -- (six) -- cycle;
\draw[fill = blue, fill opacity = 0.2] (m) -- (three) -- (uniform)  -- (four) -- cycle;

\draw (halfonethree) -- (one) -- (uniform) -- (three)  -- cycle;
\draw (halfonetwo) -- (two) -- (uniform) -- (six)  -- cycle;
\draw (halftwothree) -- (four) -- (uniform) -- (five)  -- cycle;

\draw[thin, blue, dashed, opacity = 0.3] (h) -- (uniform);
\draw[thin, blue, dashed, opacity = 0.3] (m) -- (uniform);
\draw[thin, blue, dashed, opacity = 0.3] (l) -- (uniform);
\end{scope}

\node[rotate=90] (kiteone) at (5/12, 5/12, 1/6) {\scalebox{.3}{$(1,0,1)$}};
\node[rotate=30] (diamond) at (9/16, 4/16, 3/16) {\scalebox{.3}{$(1,0,0)$}};
\node[rotate=15] (triangle) at (5/8, 5/16, 1/16) {\scalebox{.3}{$(2,0,1)$}};
