...
\end{claim}
\begin{proof}
	As $\hyp(g_{\V^*})$ is polyhedral, each of its faces are convex polytopes, and is also a face of some facet of $\hyp(g_{\V^*})$; these facets are defined by $\V^*$ and $\Y$ (Corollary 6).
