...
Recall from the introduction Theorem~\ref{thm:embed-poly-informal}.
\embedpolyinformal*
This result is exactly the chaining of theorems \ref{thm:poly-embeds-discrete} and \ref{thm:discrete-loss-poly-embeddable}, thus we have shown the result.
