...
(This fact is non-trivial; see Lemma~\ref{lem:embed-implies-indirect-elic}.)\jessiet{Flag; empty reference now}
...
The key idea behind our construction is a restatement of calibration\jessiet{for a calibrated link vs calibrated surrogate-link pair?} equivalent for discrete prediction problems, to a condition we call \emph{separation}.
