...
Combining this result with Theorem~\ref{thm:poly-embeds-discrete} establishes Theorem~\ref{thm:embed-poly-informal}.
Further combining with Theorem~\ref{thm:link-informal}, proved in the following section, this construction gives a consistent polyhedral surrogate for every discrete target loss.
...
In this section, we prove Theorem~\ref{thm:link-informal}, restated below, which gives a construction to generate calibrated links for \emph{any} polyhedral loss.
