...
\citet{wang2020weston} apply the embedding framework to understand the Weston-Watkins hinge loss for ordered partitions.
...
\end{equation}
They generalize the BEP embedding to this problem and show their extension is consistent with respect to eq.~\ref{eq:tree-loss-discrete}; we can also verify this is an embedding and subsume their result through Theorem~\ref{thm:poly-ie-implies-consistent}.
...
\btw{Yutong's paper commented out here}
