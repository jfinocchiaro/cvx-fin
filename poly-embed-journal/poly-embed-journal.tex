...
\reviewer{Restated Thm 1 and gave a short proof}
\embedpolyinformal*
...
\reviewer{Restated theorem 2 and gave formal proof}
\linkinformal*
\begin{proof}
...
\reviewer{Paragraph on multiclass case, using top-$k$ with $k=1$}
