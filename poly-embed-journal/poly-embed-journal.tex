...
To be effective, the surrogate must also be \emph{consistent}, meaning that minimizing it over enough data \jessie{and applying the link} solves the target problem.
...
However, \citet[Section 1.2]{ramaswamy2018consistent} contend that optimizing nonsmooth losses may enable reduction of the prediction dimension reduction while maintaining consistency relative to smooth losses, improving downstream efficiency of the learning algorithm.
...
While property elicitation has an extensive literature by now~\citep{savage1971elicitation,osband1985information-eliciting,lambert2008eliciting,gneiting2011making,steinwart2014elicitation,frongillo2015vector-valued,fissler2016higher,lambert2018elicitation}, these works are mostly concerned with point estimation problems, which is in direct contrast to polyhedral embeddings, whose structure yields a finite set of possible predictions. \jessiet{Not sure how to phrase this.}
...
The notion of \emph{calibration} (Definition~\ref{def:calibrated}) is equivalent to consistency in finite prediction settings~\citep{bartlett2006convexity,tewari2007consistency,ramaswamy2016convex} and depends solely on the conditional distribution over $\Y$.
...
\jessiet{Commented out the following sentence as it was repetitive from line 407. - Mar 24 22}
