...
L(u,y) = \sum_{i \in \Y : i \neq y} (1 - (u_y - u_i))_+~.~
\end{equation}
While it was later shown to be inconsistent\raf{Jessie: add cite?}, \citet{dogan2016unified} nonetheless advocate for the Weston-Watkins SVM to be the default for multiclass prediction problems.
