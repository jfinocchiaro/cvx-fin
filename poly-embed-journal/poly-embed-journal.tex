...
When juxtaposed with multiclass classification in Figure~\ref{fig:abstain-intuition-inconsistent}, one can observe that the BEP surrogate does not indirectly elicit, and therefore does not embed, the mode.
