...
\raf{Jessie: take a crack at filling in the rest with our newer results}
\end{abstract}
...
\raft{This sentence seems odd here, but it's a nice reference; is there a better place?}
...
For target losses and properties, we will take $\R$ to be any finite set, and use lowercase notation $\ell$ and $\gamma$, respectively.
...
\raft{Rewrote to (hopefully) make our notational conventions clearer}
...
\raft{I trimmed this discussion and footnoted the $n-1$ construction, and then folded the last paragraph above the theorem}
