...
%
\jessie{ TODO Items 04 Mar 2021
	\begin{itemize}
		\item Reorg sections: \S 3 (Embeddings, matching risks, etc.), \S 5 (Calibrated link), Examples, \S 4 (Polyhedral losses: I.E. implies consistency) OR Main results (w/o proof), Examples, \S 3, \S 5, \S 4
		\item Flesh out and expand on Ordered Partition Example
		\item add paragraph of discussion on the requirements of polyhedral losses
		\item Check proof and statement of Theorem~\ref{thm:poly-ie-implies-consistent}
\end{itemize}}

\jessie{ TODO Items summer 2020
	\begin{itemize}
