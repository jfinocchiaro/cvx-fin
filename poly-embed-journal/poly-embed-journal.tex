...
\begin{proof}
  ...
  By Theorem \ref{thm:small-eps-thick}, in particular there exists an $\epsilon$ such that $\psi$ is well-defined everywhere.

  To prove separation, suppose $u$ and $p$ are give such that $d_{\infty}(u,U) \leq \epsilon$, where $U = \Gamma(p)$.
