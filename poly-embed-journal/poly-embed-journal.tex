...
$1 \Rightarrow 2, 3$:
Since $\Gamma$ embeds a finite property $\gamma$ with minimum representative set $\Sc$, $\Gamma$ also has a finite minimum representative set $\U := \varphi(\Sc)$. (3).

For (2), we claim $\trimnonred(\Gamma) = \{\Gamma_u \mid u \in \U\}$, and the result follows from $\U$ being a finite minimum representative set.
