...
Hence, our framework could have simplified the process of finding $\psi^\infty$, and the corresponding proof of consistency and surrogate regret bounds (\S~\ref{subsec:regret-bounds}\raft{check whether our bounds match}).
