...
\begin{restatable}{proposition}{embedtrim}\label{prop:embed-trim}
  ...
  Moreover, when any of the above hold, $\trimnonred(\gamma) = \trimnonred(\Gamma) = \{\Gamma_u : u\in\U\} = \Theta$.\jessiet{Also, should this statement be $\trimcover(\gamma) = \trimnonred(\gamma) = \trimcover(\Gamma) = \trimnonred(\Gamma) = \{\Gamma_u \mid u \in \U\} = \Theta$? But also, can we pull it out into its own statement? It should follow as a corollary of this and an analogous version of Prop 6.}
\end{restatable}
\begin{proof}
