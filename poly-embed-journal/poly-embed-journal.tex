...
\reviewerone{Comment 1}
\reviewerthree{Comment 1}
...
\end{align*}
In particular, this surrogate is consistent with respect to 0-1 loss using the canonical argmax link, while the Weston-Watkins hinge is not consistent for any link (\S~\ref{sec:winge}).
