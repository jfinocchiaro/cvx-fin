...
In structured binary classification and top-$k$ classification, our framework also gives new consistent surrogates and link functions which would likely have been extremely challenging to derive without our framework. \jessiet{Want to be careful on this claim and make sure it doesn't sound like we do both surrogate and link for both.}
