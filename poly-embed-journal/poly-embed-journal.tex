...
$3 \Rightarrow 4$:
Since level sets of elicitable properties are closed, the set $\Theta = \{\Gamma_u \mid u \in \U\}$ yields a finite covering of the simplex.
Moreover, by Lemma~\ref{lem:finite-minrep-weakly-dominate}, we have each level set in $\{\Gamma_u \mid u \in \U\}$ full-dimensional.
