...
Their full proofs appear in Appendix \ref{sec:equiv-sep-calib}.
...
We use $\Psi(u)$ to denote the remaining legal choices for $\psi(u)$ after imposing the requirements for each such set.
