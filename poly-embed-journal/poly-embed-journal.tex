...
\begin{proposition}\label{prop:tfae-min-rep-nonredundant}
	...
	\begin{enumerate}
		...
		\item[c.] For all $r \in \R$, $\Gamma_r$ is full-dimensional, the multiset $\{\Gamma_r : r \in \R\}$ has no duplicate elements, and $\cup_{r\in\R} \Gamma_r = \simplex$.
	\end{enumerate}
\end{proposition}
\begin{proof}[Sketch]
	$(a \implies b)$  
...
\begin{corollary}
	If $\R$ is a minimum representative set for $L$ eliciting $\Gamma$, then $L$ tightly embeds $L|_\R$.
\end{corollary}
