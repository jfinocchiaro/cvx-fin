...
We also use these result to understand deeper structure of embeddings, even down to the geometry of the underlying properties. %, and the equivalence of various notions of non-redundant predictions.
...
%% intro to Lemma X
We now present our main structural result in Lemma~\ref{lem:X}, which we prove in \S~\ref{app:polyhedra}.
%This result lays the foundation for the rest of this section.
...
\raf{Short parag on why we care about trim}\jessie{Attempted; burn? i don't like this.}
Trimmed losses allow us to understand ``where the action happens'' even in the best case scenario where the loss vector is optimal for \emph{some} data distribution. \jessie{phrasing}
In what follows, we relate the trimmed form of a loss to the concept of redundancy in property elicitation.
