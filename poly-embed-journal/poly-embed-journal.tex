...
\begin{remark}\label{remark:embed-trim}
	...
	\end{enumerate}
Moreover, when $\Gamma$ tightly embeds $\gamma$, $\U$ is a minimum representative set, and there is a $\Theta' \subseteq \Theta$ has no duplicate elements such that $\cup \Theta' = \simplex$.
\end{remark}
\begin{proof}[Sketch]
	$(a \implies b)$
