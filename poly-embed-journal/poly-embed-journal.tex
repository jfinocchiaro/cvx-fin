...
\jessie{Lemma X}
\begin{lemma}
  Let $f: \reals^n_+ \to \reals_+$ be a (concave) polyhedral function.
  There exists a unique set of loss vectors $\V$ of minimum cardinality such that $f(p) = \min_{v \in \V} \inprod{v}{p}$.
