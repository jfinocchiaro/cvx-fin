...
\begin{enumerate}
	...
	See margin comment 1 in orange.
	...
	Each element of $\mathcal{U}$ is a set, so the union $\cup \mathcal{U}$ is a set of real-valued $v \in \mathbb{R}^d$; hence it is not a typo. 
\end{enumerate}
