...
When working with a restricted hypothesis class $\H$, as opposed to the set of all measurable functions in Definition~\ref{def:consistency}, then the corresponding notion of consistency (called \emph{$\H$-consistency}) is no longer equivalent to calibration~\citep{long2013consistency,kuznetov2014multi,zhang2020convex};
