...
We use Definitions~\ref{def:consistent-ell} and~\ref{def:consistent-prop} to show lower bounds on consistent prediction dimension through indirect elicitation, so in this case, the weakness of $\D$-consistency actually demonstrates the strength of elicitation as a tool to show lower bounds about consistency.\jessie{Revisit}
