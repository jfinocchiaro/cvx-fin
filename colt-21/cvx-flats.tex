...
As definitions of consistency are relatively intractable to apply directly, the literature often focuses on a weaker condition called calibration~\citep[Chapter 3]{steinwart2008support}, which only applies when given a discrete target loss.
...
\raf{Check me!}\jessie{<< From NeurIPS.  I'm good with this}
...
\begin{definition}[Consistent: property]\label{def:consistent-prop}
  ...
  \raft{Ditto; hopefully this is equivalent to what was here before (commented out below)\jessie{Looks good to me}}
...
\jessie{Talk about BEP? though less detail than old intro- mention tight bounds for $n = 3$.}
