...
In Definition \ref{def:consistent-prop}, we introduce a notion of consistency in which one is given a \emph{target statistic}, such as the conditional variance or quantile, as in classical statistics, but no target loss~\citep{gyorfi2006distribution, fan1998efficient,ruppert1997local}.
