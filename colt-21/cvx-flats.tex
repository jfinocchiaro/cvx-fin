...
\begin{abstract}
  ...
  Techniques to design and analyze surrogate losses in these scenarios are typically studied by different frameworks.%: first, when one is given a target loss for a finite prediction task, and second, when one simply has a statistic they would like to estimate.
