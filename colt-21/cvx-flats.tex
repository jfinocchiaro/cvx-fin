...
If there is some $p \in \P$ with $|\gamma(p)| = 1$, and $\gamma(p) = \{r\}$ such that there is no flat $F$ of \Pcodimension at most $d$ with $p \in F \subseteq \gamma_r$, then $L$ does not indirectly elicit $\gamma$, and in particular, there is no convex surrogate $L \in \L_d$ consistent with respect to $\gamma$.
...
If there is a $p \in \relint{\P}$ such that there is no flat $F$ of \Pcodimension at most $d$ with $p \in F \subseteq \gamma_r$, then $L$ does not indirectly elicit $\gamma$, and in particular, there is no convex $L \in \L_d$ consistent with respect to $\gamma$.
%
