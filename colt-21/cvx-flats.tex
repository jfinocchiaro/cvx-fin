...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{tikz/consistency-elicitation-calibration.pdf}
	\caption{The four quadrants of prediction tasks; Theorem~\ref{thm:consistent-implies-indir-elic} allows us to understand the relationship between indirect elicitation and consistency in all four quadrants for the first time.\jessie{Move to side of figure}}
	\label{fig:four-quadrants}
\end{figure}
...
\section{Background and Related work}\label{sec:related-work}\jessie{Be careful with name of section}
