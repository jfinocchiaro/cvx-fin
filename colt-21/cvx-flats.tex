...
\node[vertex] (indir-elic) at  (-4,-2) {Indirect elicitation};
\node[vertex] (d-flats) at  (2,-2) {$d$-flats};
\node[vertex] (conscvx-bd) at (8,0) {$\conscvx(\gamma) \leq d$};
\node[vertex] (q1-bounds) at (14,2) {$\conscvx$ bounds for Q1};
\node[vertex] (q4-bounds) at (14,-2) {$\conscvx$ bounds for Q4};
...
\draw[edge] (d-flats) to node[above, sloped]{{\footnotesize Cors.~\ref{cor:Pcodim-flat-single-val-prop}, \ref{cor:Pcodim-flat-elic-relint-prop}}} (conscvx-bd);
\draw[edge] (consis-gam) to node[above, sloped]{\footnotesize {Cors.~\ref{cor:Pcodim-flat-single-val-prop}, \ref{cor:Pcodim-flat-elic-relint-prop}}} (conscvx-bd);
