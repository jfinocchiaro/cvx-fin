...
In the machine learning literature, calibration~\citep[Chapter 3]{steinwart2008support} is typically the tool used to study consistency.
...
We observe the condition on the existence of $\D$ may seem weak; we use Definitions~\ref{def:consistent-ell} and~\ref{def:consistent-prop} to show lower bounds on consistent prediction dimension through indirect elicitation, so in this case, this actually demonstrates the strength of elicitation as a tool to show lower bounds about consistency.\jessie{Revisit}
