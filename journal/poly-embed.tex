...
Literature directly connecting property elicitation to consistency is sparse, with the main reference being~\citet{agarwal2015consistent}; note however that they consider single-valued properties, whereas properties elicited by general convex losses are necessarily set-valued.\jessiet{It might be a little more subtle than that; \cite{agarwal2015consistent} does have a section on set-valued properties IIRC}
