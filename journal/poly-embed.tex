...
\end{definition}
It is well-known that calibration implies \emph{consistency}, in the following sense (cf.~\citep{agarwal2015consistent}).
...
%    To see this, consider that Condition (i.) of matching embedded loss values is met by construction of $\ell$.
    ...
    We aim to show that for all $p \in \simplex$, we have $(1) \inf_{u \in \reals^d}\inprod{p}{L(u)} = (2) \inf_{r \in \R}\inprod{p}{L(\varphi(r))}$, and the equality of risks follows.
