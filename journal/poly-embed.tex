...
The examples in Section~\ref{sec:examples}, with the exception of the abstain surrogate given by ~\cite{ramaswamy2018consistent}, all present a surrogate that use the link $\psi: u \mapsto \sgn(u)$.
...
\jessie{Everything below here is added from the COLT-19 version}
...
\begin{conjecture}
	...
	Then an embedding for $\gamma'$ can also embed $\gamma$.
\end{conjecture}
