...
\begin{itemize}
	...
	Seems to work in practice, but isn't statistically consistent. \url{https://www.tandfonline.com/doi/pdf/10.1080/01621459.2017.1282372?needAccess=true}
	 ...
	 \item \url{http://jmlr.csail.mit.edu/papers/volume5/zhang04b/zhang04b.pdf} Section 4 in general might be handy, asmight Appendix A.
	 \jessie{I think this one might be one of our best shots at an example.}
	 
	 \item To read: \url{http://www.jmlr.org/papers/volume10/rudin09b/rudin09b.pdf}
...
\item Theorem: $\ell$ 1-embeddable iff $\ell$ 1-embeddable via polyhedral loss iff $\ell$ order-sensitive.
...
\item Theorem: TFAE for all the complexity classes.
\end{itemize}
...
\end{definition}
\jessiet{What if $\Gamma_u = \Gamma_{u'}$?  Would we remove both copies of the level set as is?}
...
\begin{theorem}\label{thm:polyhedral-embed}
  ...
  Moreover, a polyhedral loss $L$ indirectly elicits \raft{NO LONGER DEFINED} a non-redundant elicitable property $\gamma$ if and only if $\gamma$ is finite and $L$ embeds a property which refines $\gamma$.
\end{theorem}
