...
\section*{Raf's attempt at new Background}
...
\subsection{Notation, losses, and links}
...
(A generic loss will also be written $L$.)
...
We omit the details connecting this definition to consistency, and instead refer the reader to \raf{HARI} (See the proof of Theorems 8.1-8.3.).
