...
Now, for example, consider the surrogate given by Yang and Koyejo~\cite{yang2018consistency}, \jessie{... $\psi_1$ is worked out, but would rather have $\psi_2$.  Working on it.}
