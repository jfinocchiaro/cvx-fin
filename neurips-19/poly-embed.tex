...
\begin{enumerate}
	...
	\item Reviewer 1
	\begin{enumerate}
		\item \jessie{Clarify terms like \emph{reports} and \emph{properties}.}
	\end{enumerate}
	\item Reviewer 2 (didn't change review)
	\begin{enumerate}
		\item Provide more intuition for definitions
	\end{enumerate}
	\item Reviewer 3 (didn't change review)
	\begin{enumerate}
		\item \raf{Add discussion on the computational complexity (or lack thereof) of constructing $L$ and $\psi$}
