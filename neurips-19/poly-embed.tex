...
Appendix~\ref{app:calibration} in the full version~\cite{finocchiaro2019embedding} contains the full proof; this section provides a sketch along with the main construction and result.
...
\jessie{What we had commented for space}
