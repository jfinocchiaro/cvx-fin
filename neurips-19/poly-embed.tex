...
Moreover, the link function $\psi$ is exactly the link obtained from Theorem~\ref{thm:eps-thick-calibrated} with the norm being $\|\cdot\|_\infty$ and $\epsilon=1/2$.
