...
\begin{proof}[Proof of Theorem~\ref{thm:polyhedral-embed}]
  ...
  \jessiet{Do we need to show the preimage of $\Gamma$ is $\F$?}
  \raft{This question doesn't type check... yeah, can't figure out what you are asking.  Maybe that $\Gamma$ is onto $\F$?  We don't need to show that (and it's not true).}
