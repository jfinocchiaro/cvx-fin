...
In this approach, one embeds each of the finitely many predictions (e.g. classes) as a point in $\reals^d$, assigns the original loss values to these points, and convexifies the loss in between to obtain a surrogate.  
...
We illustrate the power of this embedding framework with succinct proofs of consistency or inconsistency of various polyhedral surrogates in the literature.
\end{abstract}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Proving (in)consistency via embeddings}\label{sec:examples}
...
The top $k$ classification problem takes as input a vector $r \in \R = \{r \in \{0,1\}^n \text{ such that } |r| = k\}$, and observes outcome $y \in [n]$
