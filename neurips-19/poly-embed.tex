...
Nevertheless, nonsmooth losses, such as the polyhedral losses we consider, have been proposed and studied for a variety of classification-like problems\cite{boser1992training}\jessiet{Do we want the SVM (Boser) cite?}\raft{Basically anything we talk about in the examples. removed hari from this link since we mention it next}
...
for all $p \in \simplex$,
  ...
  \end{equation}
\end{definition}
It is well-known that calibration implies \emph{consistency}, in the following sense~\cite{agarwal2015consistent}.
