...
\begin{definition}[Property, elicits, level set]
	...
	A \emph{property} is a (possibly set-valued) function $\Gamma : \simplex \to \R$ mapping distributions to reports.
...
\end{definition}
\jessie{Explain to reader why this is a good def.}
...
\jessie{On the backburner: consistency of regression.  Note down references on consistency of regression.}
