...
In the proof of Theorem~\ref{thm:consistent-implies-indir-elic} below, we modify the argument of~\cite[Corollary 7]{frongillo2018elicitation} to bound the elicitation complexity of the Bayes Risk of the loss.
\begin{theorem}
