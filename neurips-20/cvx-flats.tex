...
In addition to the two possible targets, we may have one of two domains: a \emph{discrete} (and finite)\btw{Bo: added ``and finite''} target prediction space, like a classification problem, or a \emph{continuous} one, like a regression or estimation problem.
