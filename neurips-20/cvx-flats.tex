...
\raft{Cleaned up this prev sentence}
...
Our main result (\S~\ref{sec:char-convex}, Theorem~\ref{thm:cvx-flats}) characterizes
\raft{Not a characterization!}
