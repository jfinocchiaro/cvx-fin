...
\begin{definition}[Consistent: loss]
	...
	For all distributions $D$ over input and label spaces $\X \times\Y$, we say a loss and link $(L,\psi)$ \jessiet{change order of this sentence} are consistent with respect to an original loss $\ell$ if 
	\begin{align*}
