...
Our result generalizes a calibration result of \citet{ramaswamy2016convex} to all of the above \botodo{Again we mention the four settings, but we haven't said what they are. probably should either say it explicitly, or change this to something like ``all the above settings''} settings, yielding to our knowledge the most general such bound.
