...
%\raft{FYI: use citet when treating citations as nouns; citep is used when the citation does not participate in the grammar, like: ``That is funny [Noah Alexander Frongillo, personal communication, 5/31/2020].''  Not sure what 'cite' does in this style...}\jessiet{Noted, and propagated}
...
Their results has led to the design of consistent convex surrogates for discrete prediction problems such as hierarchical classification~\citep{ramaswamy2015hierarchical} and high-confidence classification~\citep{ramaswamy2018consistent}.
...
\botodo{Added comparison to AA15; please proofread!\jessie{looks good to me}}
...
\begin{minipage}{0.4\linewidth}
	...
	\caption{Any flat $F$ with $\codim(F) = 1$ through \textbullet \, also leaves the cell $\gamma_\bot$. %However, for the distribution $p = (1/4, 1/4, 1/2)$, there is a $1$ dimensional flat containing $p$ that is a subseteq of $\gamma_\bot$ and $\gamma_3$.
	}
...
\end{proposition}\btw{Okay if $\Gamma$ is empty}
\begin{proof}
$\implies$
