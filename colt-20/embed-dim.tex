...
In particular, a lower bound on the dimensionality of \emph{any} calibrated convex surrogate $L$ implies in particular a lower bound on polyhedral surrogates. \jessie{Is it this or vice versa?} \bo{I think this is the correct statement. If we cannot have any convex cal. surrogate in $d$ dimensions, then we definitely can't have a polyhedral one.}
...
\begin{proof}
  ...
  As the labels on normals $v_2$ and $v_3$ (and therefore, the respective witnesses), it suffices to just show cases $(i.)$ and $(ii.)$.
