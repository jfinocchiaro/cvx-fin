...
\begin{restatable}{proposition}{orderableiffpath} \label{prop:orderable-iff-path}
  ...
  \jessiet{Bo in FIXME: ``Proposition 10: why is the incorrect 'definition' of path still there?''}\jessiet{Added: and two nodes have degree one}
\end{restatable}
...
\acks{Jessie Finocchiaro was funded by NSF Graduate Research Fellowship under grant \# DGE 1650115. \jessie{Others...?}}
