...
\begin{proposition} \label{prop:orderable-iff-path}
  A finite property $\gamma$ is \emph{orderable} if and only if its intersection graph is a path, i.e. a connected graph\jessiet{tree?} where every vertex has either one or two neighbors.
\end{proposition}
...
\jessiet{Left off here 02.10.2020}
