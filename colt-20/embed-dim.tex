...
\begin{proof}
  ...
  By construction, we have $\partial^-\ell(\varphi(r_1)) = -K\ones$ and $\partial^+\ell(\varphi(r_k)) = \Lambda_k K\ones$, and for $i\in\{1,\ldots,k-1\}$ we have $\partial^+\ell(\varphi(r_i)) = \partial^-\ell(\varphi(r_{i+1})) = \Lambda_i v(i+1)$.  
  ...
  (Note that the other conditions, $-K \leq 0$ or $0 \leq \Lambda_k K$, are true regardless of $p$.)
