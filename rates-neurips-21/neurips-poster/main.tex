\documentclass[t,mathserif,11pt,aspectratio=1610,handout]{beamer}
...
\begin{frame}{~}{}
  \vskip-1em
  \centerline{\includegraphics[width=0.75\linewidth]{figs/hinge}}
  \vskip1em
  ...
  \textbf{Non-polyhedral:} There exist cases where \blueem{surrogate regret} $\leq \epsilon$ yet \redem{target regret} $\geq \Omega(\sqrt{\epsilon})$.

  \smallskip
  \enumitem{\bf Theorem 2:} All sufficiently ``non-polyhedral'' surrogate transfers are \textbf{quadratically slower}.
\end{frame}
