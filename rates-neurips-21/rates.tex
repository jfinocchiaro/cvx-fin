...
\raft{I didn't get much out of this paragraph (apart from the first sentence), whereas I thought the next one was really useful.  I think I'll combine with a shortened version of the first, like ``Theorem 1 in \S, Theorem 2 in \S.  We make Theorem 1 constructive in \S...''}
...
In particular, a polyhedral loss has some finite set of reports which always contains a minimizer~\cite{finocchiaro2019embedding}.\raft{FYI, you were using our embedding dimension paper; I fixed throughout}
