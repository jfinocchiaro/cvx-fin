...
\botodo{Notation changed: $L(h(X),Y) \to L(h(X))_Y$.}
\raft{Good call, though I wonder if we should ditch the vector notation for this paper, since it really makes this hard to read...}
