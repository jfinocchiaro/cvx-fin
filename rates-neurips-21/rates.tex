...
\end{enumerate}
\bo{Not sure what to say here.}
We view both parts as relatively surprising.
The first contains several important technical steps, as we will outline next.
Intuitively, it is not clear why the first part should imply the main result: it might be that $\sup_p \alpha_p = \infty$, for example, by approaching a boundary.
