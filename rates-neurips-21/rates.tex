...
We now arrive at the key fact about polyhedral losses we will use.
...
The definition was introduced in \cite{finocchiaro2019embedding}.
...
Since $R_\ell$ is convex in $p$, in particular this maximum is achieved at a vertex of the probability simplex.\raft{Bo: double check}
