...
\begin{abstract}
  ...
  \raft{need to add keyword and/or mention: ``excess risk bounds'' (more common in the literature actually) \bo{Did above} \raf{I wasn't clear; fixed}}
\end{abstract}
...
\begin{definition}[Calibratied, Indirect Elicitation]
