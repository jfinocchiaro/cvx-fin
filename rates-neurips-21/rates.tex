...
\bo{We are assuming Bayes in class here. Should comment about it, maybe discuss!}
...
To systematize the investigation of this problem, we formalize the notion of \emph{surrogate transfer bounds}.
