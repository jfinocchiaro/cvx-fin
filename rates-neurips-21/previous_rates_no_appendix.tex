...
While much is known about surrogate regret bounds for particular problems, such as binary classification~\citep{zhang2004statistical,bartlett2006convexity,reid2009surrogate,mahdavi2014binary}


and bipartite ranking, general results which span multiple target problems are sparse.
...
\end{lemma}
\begin{proof}
  This follows directly from \cite{finocchiaro2020embedding}.
  \bo{prove, cite, etc}
\end{proof}
